...
class Apollo(Optimizer):
    '''
        Based on paper <Apollo: An Adaptive Parameter-wise Diagonal Quasi-Newton Method for Nonconvex Stochastic Optimization>
        pytorch implementation 
        @ https://github.com/XuezheMax/apollo/tree/master
    '''
